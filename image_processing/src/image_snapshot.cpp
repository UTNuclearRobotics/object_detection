...
namespace image_snapshot {
      ...
      private_nh_("~")
  {
    ...
    compressed_image_sub_ = nh_.subscribe("image/compressed", 1, &ImageSnapshot::compressedImageCb, this);
    camera_info_sub_ = nh_.subscribe("camera_info", 1, &ImageSnapshot::cameraInfoCb, this);

    snapshot_server_ = private_nh_.advertiseService("send_snapshot", &ImageSnapshot::sendSnapshot, this);
  ...
  void ImageSnapshot::cameraInfoCb(const sensor_msgs::CameraInfoConstPtr msg) {
    camera_info_ = *msg;
  }


  void ImageSnapshot::imageCb(const sensor_msgs::ImageConstPtr &msg) {
    image_ = *msg;
  }
  ...
  bool ImageSnapshot::sendSnapshot(image_processing::Snapshot::Request &req, image_processing::Snapshot::Response &res) {
